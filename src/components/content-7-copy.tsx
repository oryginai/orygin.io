...
// function ScrollTriggeredSection({ children, threshold = 0.2 }) {
...
//         <section className="py-16 md:py-32">
//             <div className="mx-auto max-w-5xl space-y-8 px-6 md:space-y-16">
//                 <h2 className="relative z-10 max-w-xxl text-4x1 font-medium lg:text-5xl">The Orygin AI ecosystem revolutionizes business automation.</h2>
//                 <div className="grid gap-6 sm:grid-cols-2 md:gap-12 lg:gap-24">
//                     <div className="relative space-y-4">
//                         <p className="text-muted-foreground">
//                             We don&apos;t just build AI. <span className="text-accent-foreground font-bold">We create an ecosystem</span> — where intelligent systems work together, replacing inefficiency with automation.
//                         </p>
//                         <p className="text-muted-foreground">It&apos;s more than just AI—it&apos;s a powerhouse of automation, decision-making, and optimization designed to help businesses scale effortlessly.</p>
