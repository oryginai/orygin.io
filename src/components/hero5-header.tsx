...
//     // Use a consistent initial state to avoid hydration mismatch
//     const [isScrolled, setIsScrolled] = React.useState(false)
//     // Use this to prevent transitions during initial render
...
//     // Basic class without useMemo to avoid SSR/client mismatch
//     const navbarClasses = cn(
//         'mx-auto mt-2 px-6 lg:px-12',
//         isLoaded && 'transition-all duration-300',
//         isScrolled ? 'max-w-4xl bg-background/50 rounded-2xl border backdrop-blur-lg lg:px-5' : 'max-w-6xl'
//     )
...
//                                         <ArrowUpRight className="ml size-4" />
//                                     </Link>
//                                 </Button>
//                                 <Button
//                                     asChild
